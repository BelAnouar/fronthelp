            ...
            <header className='shadow-md font-sans'>
                <nav className="flex items-center justify-between bg-[#00bd82] text-white text-right">
                    ...
                    <div className="py-4 px-8">
                        <p className="text-sm">
                            <strong>Address:</strong> SWF New York 185669
                            <strong>Contact No:</strong> 1800333665
                        </p>
                    </div>
                </nav>
                ...
                <div
                    ...
                    <nav className={"flex flex-row flex-nowrap  items-center static bg-transparent h-24"}>
                        ...
                        <ul id="collapseMenu" className="flex flex-1 items-center justify-start ml-28 space-x-6">
                            <li>
                                <a href="#"
                            ...
                            <li>
                                <a href="#"
                                   className="text-gray-700 hover:text-gray-900 text-base font-normal leading-5 text-lg">Team</a>
                            </li>
                            <li>
                                <a href="#"

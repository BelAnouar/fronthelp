    ...
    return (
        <div className=" flex   p-5 items-center">
            ...
            <div className="md:w-1/2 px-8 mx-auto md:px-10">
                ...
                <a href={"http://localhost/api/auth/google"} className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
                    <svg
                        className="mr-3"
                ...
                <form onSubmit={formik.handleSubmit} className="flex flex-col gap-4">
                    <input
                        className={`p-2 mt-8 rounded-xl border w-full ${formik.errors.email && formik.touched.email ? "border-red-500" : ""}`}
                        type="email"
                        name="email"
                        placeholder="Email"
                ...
                <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                    ...
                    <button type={"submit"} className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">
                        Register
                    </button>
                </div>
            </div>
